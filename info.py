...
# MongoDB information
SECONDDB_URI = environ.get('SECONDDB_URI', "mongodb+srv://Mamitha:Mamitha@cluster0.wlmu25d.mongodb.net/")
...
REQ_CHANNEL=environ.get("REQ_CHANNEL", "-1002021109264")
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002229783257').split()]
