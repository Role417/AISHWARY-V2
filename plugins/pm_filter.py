...
from utils import get_size, is_subscribed, get_poster, temp, get_settings, save_group_settings, get_shortlink, send_all, check_verification, get_token, imdb
...
2️⃣ നിങ്ങൾ ചോദിച്ച സിനിമ തീയറ്ററിൽ റിലീസ് ആയതാണോ എന്ന്  ഉറപ്പുവരുത്തുക <a href=https://t.me/+KDigxJBnAKo5MGU1> 𝐏𝐑𝐄𝐃𝐕𝐃 𝐔𝐏𝐃𝐓𝐄𝐒 </a> യിൽ ചെക്ക് ചെയ്യുക..!!
...
async def filter_yearss_cb_handler(client: Client, query: CallbackQuery):
    ...
    if offset != "":
        ...
        btn.append(
                    [InlineKeyboardButton(text="🎬 𝑹𝑬𝑸𝑼𝑬𝑺𝑻 𝑮𝑹𝑶𝑼𝑷 🎬", url=f"https://t.me/ARAKAL_THERAVAD_GROUP_03")]
        )
    await query.edit_message_reply_markup(InlineKeyboardMarkup(btn))
    temp.SEND_ALL_TEMP[key] = files
...
async def filter_seasons_cb_handler(client: Client, query: CallbackQuery):
    ...
    btn.insert(0, 
        [
           InlineKeyboardButton("🔺𝐎𝐓𝐓 𝐔𝐏𝐃𝐀𝐓𝐄𝐒🔺", url='https://t.me/ARAKAL_THERAVAD_GROUP_03'),
           InlineKeyboardButton("🔺𝐎𝐓𝐓 𝐈𝐍𝐒𝐓𝐆𝐑𝐀𝐌🔺", url='https://www.instagram.com/new_ott__updates?igsh=MTMxcmhwamF4eGp6eg==')
        ]
    )
    btn.insert(1, 
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton("👥 𝐑𝐞𝐪𝐮𝐞𝐬𝐭 𝐆𝐫𝐨𝐮𝐩", url=f"https://t.me/ARAKAL_THERAVAD_GROUP_01"),
